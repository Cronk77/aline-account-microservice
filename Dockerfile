...
COPY . /aline-account-microservice
...
# Run Program
WORKDIR /app/
COPY --from=build /aline-account-microservice/account-microservice/target/account-microservice-0.1.0.jar account_jar
EXPOSE ${APP_PORT}
CMD java -jar account_jar
